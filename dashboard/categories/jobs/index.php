...
curl_setopt_array($curl, array(
    CURLOPT_URL => $admin->apiURL()."/api/admin/categories/sub/higher/3",
            ...
            <div class="animated fadeIn">
                <div class="card">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="list-inline">
                                                ...
                                                <li class="list-inline-item" title="More"><a href="<?php echo $admin->domain()?>/dashboard/categories/jobs/subcategories?item=<?php echo $key['id']?>"> Sub categories <i class="fa fa-arrow-right"></i></a></li>
                                            </ul>
                                        </td>
                                    </tr>
                                    <?php
                    ...
                    <div class="card-footer">
                        <a href="<?php echo $admin->domain()."/dashboard/categories/jobs/add.php"; ?>" class="btn btn-success">Add Sub Category</a>
                    </div>
                </div>
