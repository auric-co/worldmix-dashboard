...
<head>
    ...
    <title>Add Jobs Category - Worldmix</title>
    <!-- Icons-->
...
<div class="app-body">
    ...
    <main class="main">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="./categories/jobs">Jobs</a> </li>
                ...
                <div class="card">
                    ...
                    if(isset($_POST['submit'])) {
                        ...
                        curl_setopt_array($curl, array(
                            CURLOPT_URL => $admin->apiURL() . "/api/admin/add/subcategory/higher/3",
                    ...
                    if (isset($_POST["import"])) {
                        ...
                        $curl = curl_init();
                        curl_setopt_array($curl, array(
                            CURLOPT_URL => $admin->apiURL() . "/api/admin/add/upload/3/higher",
                            CURLOPT_RETURNTRANSFER => true,
                            CURLOPT_ENCODING => "",
                            CURLOPT_MAXREDIRS => 10,
                            CURLOPT_TIMEOUT => 30,
                    ...
                    ?>
                    <div class="card-header"> Add Jobs Sub Categories</div>
                    <div class="card-body">
