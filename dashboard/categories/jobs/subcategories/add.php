...
<head>
    ...
    <title>Add Vehicle Category - Worldmix</title>
    <!-- Icons-->
...
<div class="app-body">
    ...
    <main class="main">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="<?php echo $admin->domain()?>/dashboard/categories/vehicle?cat=2">Vehicles</a> </li>
                ...
                <div class="card">
                    ...
                    if(isset($_POST['submit'])) {
                        ...
                        curl_setopt_array($curl, array(
                            CURLOPT_URL => $admin->apiURL() . "/api/admin/add/subcategory/medium/".$_GET['item'],
                    ...
                    if (isset($_POST["import"])) {
                        ...
                        $curl = curl_init();
                        curl_setopt_array($curl, array(
                            CURLOPT_URL => $admin->apiURL() . "/api/admin/add/upload/".$_GET['item']."/medium",
                            CURLOPT_RETURNTRANSFER => true,
                            CURLOPT_ENCODING => "",
                            CURLOPT_MAXREDIRS => 10,
                            CURLOPT_TIMEOUT => 30,
                        ...
                        if ($err) {
                            ...
                            if ($data['success'] == true) {
                                ...
                                $message = "Jobs Subcategories saved";
                    ...
                    ?>
                    <div class="card-header"> Add Vehicle Sub Categories</div>
                    <div class="card-body">
