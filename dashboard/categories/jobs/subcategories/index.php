...
if (!isset($_GET['item'])){
    header('location:'.$admin->domain().'/dashboard/category/jobs?error=item not set');
    exit();
}
...
<head>
    ...
    <title>Jobs Category - Worldmix</title>
    <!-- Icons-->
                ...
                <div class="card">
                    <div class="card-header">
                        <ul class="list-unstyled">
                            <li class="list-unstyled-item"><strong>Main Category: <span class="text-info">Jobs</span></strong></li>
                            <li class="list-unstyled-item"><b>Current: <span class="text-info">Medium Level Sub Category</span> </b></li>
                        </ul>
                    </div>
                    <div class="card-body">
                        <table class="table table-responsive-sm table-striped" id="table-jobs">
                            <thead>
                            <tr>
                                <th>ID</th>
                                <th>NAME</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="list-inline">
                                                ...
                                                <li class="list-inline-item" title="More"><a href="<?php echo $admin->domain()?>/dashboard/categories/jobs/subcategories"> Sub categories <i class="fa fa-arrow-right"></i></a></li>
                                            </ul>
                                        </td>
                                    </tr>
                                    <?php
                    ...
                    <div class="card-footer">
                        <a href="<?php echo $admin->domain()."/dashboard/categories/jobs/subcategories/add.php?item=".$id; ?>" class="btn btn-success">Add Sub Category</a>
                    </div>
                </div>
