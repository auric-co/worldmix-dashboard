...
<head>
    ...
    <title>Accommodation Sub Category - Worldmix</title>
    <!-- Icons-->
                ...
                <div class="card">
                    <div class="card-header">
                        <ul class="list-unstyled">
                            ...
                            <li class="list-unstyled-item"><b>Current: <span class="text-info">Bedrooms Categories</span> </b></li>
                        </ul>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                        <a href="<?php echo $admin->domain()."/dashboard/categories/vehicle/add.php?item=".$id; ?>" class="btn btn-success">Add Vehicle Type</a>
                    </div>
                </div>
