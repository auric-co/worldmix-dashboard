...
<head>
    ...
    <title>Add Accommodation Sub Category - Worldmix</title>
    <!-- Icons-->
...
<div class="app-body">
    ...
    <main class="main">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="<?php echo $admin->domain()?>/dashboard/categories/accommodation/types">Types</a> </li>
                ...
                <div class="card">
                    ...
                    if(isset($_POST['submit'])) {
                        ...
                        curl_setopt_array($curl, array(
                            CURLOPT_URL => $admin->apiURL() . "/api/admin/add/subcategory/medium/2",
                    ...
                    if (isset($_POST["import"])) {
                        ...
                        $curl = curl_init();
                        curl_setopt_array($curl, array(
                            CURLOPT_URL => $admin->apiURL() . "/api/admin/add/upload/2/medium",
                            CURLOPT_RETURNTRANSFER => true,
                            CURLOPT_ENCODING => "",
                            CURLOPT_MAXREDIRS => 10,
                            CURLOPT_TIMEOUT => 30,
