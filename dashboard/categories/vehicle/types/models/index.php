...
if (!isset($_GET['cat'])){
    header('location:'.$admin->domain().'/dashboard/category/vehicle?error=item not set');
    exit();
}
...
curl_setopt_array($curl, array(
    CURLOPT_URL => $admin->apiURL()."/api/admin/categories/sub/lower/".$id,
...
<head>
    ...
    <title>Vehicle Models - Worldmix</title>
    <!-- Icons-->
                ...
                <div class="card">
                    <div class="card-header">
                        <ul class="list-unstyled">
                            ...
                            <li class="list-unstyled-item"><b>Current: <span class="text-info">Lower Level Sub Category</span> </b></li>
                        </ul>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                        <a href="<?php echo $admin->domain()."/dashboard/categories/vehicle/types/models/add.php?item=".$id; ?>" class="btn btn-success">Add Sub Category</a>
                    </div>
                </div>
