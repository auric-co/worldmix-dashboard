...
<head>
    ...
    <title>Add Vehicle Model - Worldmix</title>
    <!-- Icons-->
...
<div class="app-body">
    ...
    <main class="main">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="<?php echo $admin->domain()?>/dashboard/categories/vehicle">Vehicles</a> </li>
                ...
                <div class="card">
                    ...
                    if(isset($_POST['submit'])) {
                        ...
                        curl_setopt_array($curl, array(
                            CURLOPT_URL => $admin->apiURL() . "/api/admin/add/subcategory/lower/".$_GET['item'],
                    ...
                    if (isset($_POST["import"])) {
                        ...
                        $curl = curl_init();
                        curl_setopt_array($curl, array(
                            CURLOPT_URL => $admin->apiURL() . "/api/admin/add/upload/".$_GET['item']."/lower",
                            CURLOPT_RETURNTRANSFER => true,
                            CURLOPT_ENCODING => "",
                            CURLOPT_MAXREDIRS => 10,
                            CURLOPT_TIMEOUT => 30,
