...
if (!isset($_GET['item'])){
    header('location:'.$admin->domain().'/dashboard/category/vehicle/?error=item not set&cat=4');
    exit();
}
...
curl_setopt_array($curl, array(
    CURLOPT_URL => $admin->apiURL()."/api/admin/categories/sub/medium/".$id,
...
<head>
    ...
    <title>Vehicle Types - Worldmix</title>
    <!-- Icons-->
                ...
                <div class="card">
                    <div class="card-header">
                        <ul class="list-unstyled">
                            <li class="list-unstyled-item"><strong>Main Category: <span class="text-info">Vehicles</span></strong></li>

                            <li class="list-unstyled-item"><b>Current: <span class="text-info">Medium Level Sub Category</span> </b></li>
                        </ul>
                    </div>
                    <div class="card-body">
                        <table class="table table-responsive-sm table-striped" id="table-vehicle">
                            <thead>
                            <tr>
                                <th>ID</th>
                                <th>NAME</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="list-inline">
                                                ...
                                                <li class="list-inline-item" title="More"><a href="<?php echo $admin->domain() ?>/dashboard/categories/vehicle/types/models?item=<?php echo $key['id'] ?>"> Models <i class="fa fa-arrow-right"></i></a></li>
                                            </ul>
                                        </td>
                                    </tr>
                                    <?php
                    ...
                    <div class="card-footer">
                        <a href="<?php echo $admin->domain()."/dashboard/categories/vehicle/types/add.php?item=".$_GET['item']; ?>" class="btn btn-success">Add Vehicle Type Model</a>
                    </div>
                </div>
