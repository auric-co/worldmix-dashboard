...
curl_setopt_array($curl, array(
    CURLOPT_URL => $admin->apiURL()."/api/admin/categories/sub/higher/4",
...
<head>
    ...
    <title>Vehicle Category - Worldmix</title>
    <!-- Icons-->
            ...
            <div class="animated fadeIn">
                <div class="card">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="list-inline">
                                                ...
                                                <li class="list-inline-item" title="More"><a href="<?php echo $admin->domain() ?>/dashboard/categories/vehicle/types?item=<?php echo $key['id'];?>">Types <i class="fa fa-arrow-right"></i></a></li>
                                            </ul>
                                        </td>
                                    </tr>
                                    <?php
                    ...
                    <div class="card-footer">
                        <a href="<?php echo $admin->domain()."/dashboard/categories/vehicle/add.php"; ?>" class="btn btn-success">Add Vehicle Type</a>
                    </div>
                </div>
