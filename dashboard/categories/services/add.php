...
<head>
    ...
    <title>Add Services Category - Worldmix</title>
    <!-- Icons-->
...
<div class="app-body">
    ...
    <main class="main">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="./categories/services">Services</a> </li>
                ...
                <div class="card">
                    ...
                    if(isset($_POST['submit'])) {
                        ...
                        curl_setopt_array($curl, array(
                            CURLOPT_URL => $admin->apiURL() . "/api/admin/add/subcategory/higher/1",
                    ...
                    if (isset($_POST["import"])) {
                        ...
                        $curl = curl_init();
                        curl_setopt_array($curl, array(
                            CURLOPT_URL => $admin->apiURL() . "/api/admin/add/upload/1/higher",
                            CURLOPT_RETURNTRANSFER => true,
                            CURLOPT_ENCODING => "",
                            CURLOPT_MAXREDIRS => 10,
                            CURLOPT_TIMEOUT => 30,
                        ...
                        if ($err) {
                            ...
                            if ($data['success'] == true) {
                                ...
                                $message = "Services Subcategories saved";
                    ...
                    ?>
                    <div class="card-header"> Add Services Sub Categories</div>
                    <div class="card-body">
