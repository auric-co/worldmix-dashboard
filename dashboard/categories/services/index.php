<?php
    ...
    curl_setopt_array($curl, array(
        CURLOPT_URL => $admin->apiURL()."/api/admin/categories/sub/higher/1",
...
<head>
    ...
    <title>Services Category - Worldmix</title>
    <!-- Icons-->
                ...
                <div class="card">
                    <div class="card-header">
                        <ul class="list-unstyled">
                            <li class="list-unstyled-item"><strong>Main Category: <span class="text-info">Services</span></strong></li>
                            <li class="list-unstyled-item"><b>Current: <span class="text-info">Higher Level Sub Category</span> </b></li>
                        </ul>
                    </div>
                    <div class="card-body">
                        <table class="table table-responsive-sm table-striped" id="table-services">
                            <thead>
                            <tr>
                                <th>ID</th>
                                <th>NAME</th>
                    ...
                    <div class="card-footer">
                        <a href="<?php echo $admin->domain()."/dashboard/categories/services/add.php"; ?>" class="btn btn-success">Add Sub Category</a>
                    </div>
                </div>
