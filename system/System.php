...
class System
{
    ...
    public function login(){
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => "http://localhost:9090/admin/login",
    ...
    public function createProduct(){
        ...
        $curl = curl_init();
        curl_setopt_array($curl, array(
            CURLOPT_URL => "http://localhost:9090/admin/products/add/new",
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => "",
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 30,
        ...
        if ($err) {
            ...
            echo "<script>alert('Product creation error : ".$err."')</script>";
            echo "<script>window.open('".$this->domain()."/products/add-new.php', '_self')</script>";

        } else {
            if($data['success'] == true){

                echo "<script>alert('".$data['message']."')</script>";
                echo "<script>window.open('".$this->domain()."/products/', '_self')</script>";
    ...
    public function createCategory(){
        ...
        $curl = curl_init();
        curl_setopt_array($curl, array(
            CURLOPT_URL => "http://localhost:9090/admin/products/add/category",
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => "",
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 30,
