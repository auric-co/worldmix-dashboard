...
$(document).ready(function () {
    ...
    $(".permissions").click(function () {
        ...
        var dataString = 'permission=' + id;
        dataString += '&role=' + $(this).find("input").data('role');
    ...
    $(".removebutton").click(function (e) {
        ...
        $('#confirm-delete').find('#remover').attr('href', link);
        e.stopPropagation();
    })
...
var philbert = function () {
    ...
    $('#confirm-delete').on('show.bs.modal', function (e) {
        $(this).find('#remover').attr('href', $(e.relatedTarget).data('href'));
    });

    $('#listing').select2();

    $('#delete-room').on('show.bs.modal', function (e) {
        $(this).find('#remover').attr('href', $(e.relatedTarget).data('href'));
    });

    $('#accType').change(function () {
        if ($('#accType').val() === 'lodge') {
            $('#payment-div').show();
        } else {
            $('#payment-div').hide();
        }
